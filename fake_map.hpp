...
public:
    ...
    FakeMap(const InputIterator& begin, const InputIterator& end) {
//        static_assert(std::is_same<value_type, std::decay<decltype(*begin)>::type>::value,
//            "Constructing from iterators of incompatible types");
    ...
    bool operator==(const FakeMap& other)
    {
